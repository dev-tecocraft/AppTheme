This is an android application example of UI components using Jetpack compose, App theme change, Proto DataStore(To store app theme setting), Dynamic theme(Android 12+).
